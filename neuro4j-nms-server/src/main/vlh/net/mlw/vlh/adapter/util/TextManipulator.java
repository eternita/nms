...
public interface TextManipulator
{
	 ...
	 * manipulates the StringBuffer.
	 * 
	 * @param value The StringBuffer to manipulate.
	 * @param model The Map to reference.
	 * @return The manipulated StringBuffer.
	 */
	StringBuffer manipulate(StringBuffer value, Map model);
}