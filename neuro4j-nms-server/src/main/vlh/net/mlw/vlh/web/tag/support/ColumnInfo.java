...
/** Holds attributes of a column (title, adapterProperty etc).
 * It's used to transfer information about the column among the various classes that work with it.
 *  
...
public class ColumnInfo
{
    ...
    * @param adapterPropertyName The adapter property name of the method that 
    *                     returns the value to display.
    * @param defaultSort  The default sort direction.
    * @param attributes Other attributes of the resulting tag (e.g. "abbr='an abbreviation' id='myTHId'").
    * 
    ...
    * @see net.mlw.vlh.web.tag.DefaultColumnTag#getToolTip()
    */
    ...
    * @param toolTip
    *       The tooltip of the column's title.
    * @see net.mlw.vlh.web.tag.DefaultColumnTag#getToolTip()
    */
