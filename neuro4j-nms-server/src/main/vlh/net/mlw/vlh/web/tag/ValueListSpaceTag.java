...
import net.mlw.vlh.web.util.ImagesHomeDisplayHelper;
...
public class ValueListSpaceTag extends BodyTagSupport implements ParamAddable
{
   ...
   public int doStartTag() throws JspException
   {
      ...
      pageContext.setAttribute(ImagesHomeDisplayHelper.IMAGES_HOME_ATTRIBUTE_KEY, ((HtmlDisplayProvider) tableInfo.getConfig()
            .getDisplayProvider("html")).getImageHome((HttpServletRequest) pageContext.getRequest()));
      /**
       * @author Luciano Cunha
       */
      excludeParameters();
   ...
   public void setIncludeParameters(String forwardParams)
   {
      ...
      tableInfo.getParameters().putAll(ValueListRequestUtil.getAllForwardParameters(pageContext, forwardParams, tableInfo.getId()));
   ...
   /**
    * If is your retrieved ValueList null or you forgot to send a valueList it
    * returns the ValueListNullSpacer.
    * 
...
//         LOGGER.warn("No ValueListConfigBean defined, using the default configuration.");
    ...
    * Add params to url.
    * 
    * @see net.mlw.vlh.web.tag.support.ParamAddable#addParam(java.lang.String,
    *      java.lang.String)
    */
