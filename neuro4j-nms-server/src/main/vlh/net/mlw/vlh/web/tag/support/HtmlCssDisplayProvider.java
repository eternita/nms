...
public class HtmlCssDisplayProvider extends AbstractHTMLDisplayProvider
{
   ...
   {
      StringBuffer sb = new StringBuffer(255); // reasonable initial size to avoid the need to prolonge it
      sb.append("\n<th ");
      ...
      if (columnInfo != null)
      {
         ...
         if (columnInfo.getDefaultSort() != null)
         {
            ...
            {
               sb.append(" class=\"sortable ").append(((ValueListInfo.ASCENDING.equals(direction) ? "orderAsc" : "orderDesc")))
                     .append("\"");
            }
            else
            {
