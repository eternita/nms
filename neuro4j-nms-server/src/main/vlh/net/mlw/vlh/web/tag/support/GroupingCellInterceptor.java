 ...
 * @author mwilson
 *
 * Groups cell by using lastRow.property.equsls(currentRow.property)
 */
public class GroupingCellInterceptor implements CellInterceptor
{
   /**
    * @see net.mlw.vlh.web.tag.support.CellInterceptor#isHidden(javax.servlet.jsp.PageContext, java.lang.String, java.lang.String, java.lang.Object)
    */
   public boolean isHidden(PageContext pageContext, String key, String name,
         Object value)
   {
      if( key == null )
      {
