 ...
 * the GNU Lesser General Public License as active by the Free Software
...
/**
 * This package is used in mvc controlers to better handle with the
 * ValueListHandler. It allow you to
 * <li>backup ValueList <b>info </b> to the session before redirect!</li>
 * <li>modify paging possition, focusing property and values, sorting order,
 * etc.</li>
 * <h5>Usage</h5>
 * Please, before use, set a ValueListHandler property with a reference to your
 * valueListHandler!</h4>
 * 
...
public class ValueListHandlerHelper
{
   ...
   /**
    * Return ValueListInfo from a <b>request </b> (which is preferr to session)
    * or a session or new ValueListInfo().
    * <li>If request contains any parameters, which belongs to a table with
    * the <b>tableId </b>, return the ValueListInfo from the <b>request. </b>
    * </li>
    * <li>Otherwise if the session <b>contains attribute tableId </b>, then
    * return it from the <b>session </b>.</li>
    * <li>If the request or the session <b>dosn't </b> contain the
    * ValueListInfo, return <b>new </b> ValueListInfo.</li>
    * 
   ...
   /**
    * Do 2 things:
    * <li>Backup the ValueList <b>Info to the session </b> with the
    * attribute's name <b>tableId </b> and</li>
    * <li>store Value <b>List to the request </b> with the attribute key's
    * name <b>valueListName </b></li>
    * 
    * @see ValueListHandlerHelper#backupInfoFor(HttpServletRequest,
    *      ValueListInfo, String)
    * @see ValueListHandlerHelper#setValueListTo(HttpServletRequest, ValueList,
    *      String)
    * @param request
    * @param valueList null -> info will be removed from session and storing
    *            will be skipped.
    * @param valueListName the name used in the &lt;vlh:root
    *            value="valueListName" ... to retrieve
   ...
   /**
    * Store only ValueList to request as an attribute with the name
    * valueListName.
    * 
    * @param request
   ...
   /**
    * Save ValueListInfo to the session with key of TableInfo.DEFAULT_ID. You
    * should prevent of use this method.
    * 
    * @see TableInfo#DEFAULT_ID
    * @see ValueListHandlerHelper#backupInfoFor(HttpServletRequest,
    *      ValueListInfo, String)
   ...
   /**
    * Save ValueListInfo to session with key of tableId if info is null, remove
    * the tableId attribute from session.
    * 
    * @param request HttpServletRequest
    * @param info ValueListInfo to back up to session
    * @param tableId String session's attributes name
    * @see TableInfo#DEFAULT_ID
    * <h4> during accesing session, we are not using any synchronization.</h4>
    */
   public void backupInfoFor(HttpServletRequest request, ValueListInfo info, String tableId)
   {
      ...
      if (tableId != null && tableId.length() > 0)
      {
         if (info == null)
         {
            ...
            {
               LOGGER.warn("ValueListInfo to back up is null! ValueListInfo for the tableId '" + tableId
      ...
      else
      {
         throw new NullPointerException(
               "The session unique attribute tableId is null or empty, skipped backUp of valueListInfo into the session!");
      }
   }

   /**
    * Return the name of parameter with ActionTag.ACTION_TEMP_PARAM_PREFIX
    * Example: param <b>id </b> return <b>ACTid </b>
    * 
    * @see net.mlw.vlh.web.tag.ActionTag#ACTION_TEMP_PARAM_PREFIX
    * @param request
    * @param name
    * @return String
    */
   ...
   /**
    * Return the name of parameter without ActionTag.ACTION_TEMP_PARAM_PREFIX
    * Example: param <b>id </b> return <b>id </b>
    * 
    * @see net.mlw.vlh.web.tag.ActionTag#ACTION_TEMP_PARAM_PREFIX
    * @param request
    * @param name
