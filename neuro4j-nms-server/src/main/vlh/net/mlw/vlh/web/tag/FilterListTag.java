...
public class FilterListTag extends BodyTagSupport
{
   ...
   public int doStartTag() throws JspException
   {
      ...
      parameters = new HashMap(rootTag.getTableInfo().getParameters());
   ...
   public int doAfterBody() throws JspException
   {
      ...
      if (body != null)
      {
         ...
         for (StringTokenizer st = new StringTokenizer(content, getToken()); st.hasMoreTokens();)
         {
            ...
            String value = (format == null) ? token : MessageFormat.format(format, (Object[]) new String[]
            { token });
            ...
            JspUtils.writePrevious(pageContext, (selected ? "<th>" : "<td>") + "<a rel=\"follow\" href=\"" + tableInfo.getUrl()
