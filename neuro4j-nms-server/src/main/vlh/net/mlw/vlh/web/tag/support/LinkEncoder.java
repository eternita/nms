...
/** This interface defines a means to encode a url.  
 *  This will allow for protlets and other unknow enviroments.
 * 
...
public interface LinkEncoder
{
	 ...
	 */
	String encode(PageContext pageContext, Map parameters);
}