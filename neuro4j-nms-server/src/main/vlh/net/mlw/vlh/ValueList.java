...
/** A <code>ValueList</code> contains a 
 *  <code>List</code> of beans and a 
 *  <code>ValueListInfo</code> object which
 ...
 */
public interface ValueList extends Serializable, Iterator
{
    ...
    * @return true if there more Objects in the Iterator, other
    * wise false
    */
   boolean hasNext();
