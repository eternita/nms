...
/** This class abstracts the means by which a 
 *  ValueList is retrieved by the service.
 * 
...
public interface ValueListAdapter
{
    ...
    *
    * @return A bitwise or combination of DO_NOTHING,
    *         DO_SORT, DO_PAGE and DO_FILTER.  For example:<br>
    *         <pre>
