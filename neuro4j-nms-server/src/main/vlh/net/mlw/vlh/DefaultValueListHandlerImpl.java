...
public class DefaultValueListHandlerImpl implements ValueListHandler
{
   ...
   /**
    * @see com.mlw.vlh.ValueListHander.getValueList(ValueListInfo info, String
    *      name)
    * 
    */
   public ValueList getValueList(String name, ValueListInfo info)
   {
      ...
      {
         if (valueList.getValueListInfo() != null && valueList.getValueListInfo().getSortingColumn() != null
               && valueList.getValueListInfo().getSortingDirection() != null && valueList.getList() != null)
         {
            Collections.sort(valueList.getList(), new BeanComparator(valueList.getValueListInfo().getSortingColumn(), valueList
                  .getValueListInfo().getSortingDirection().intValue()));
