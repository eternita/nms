            ...
            <table width="100%" cellspacing="0" cellpadding="0" border="0" class="l r t b">
			    ...
			    <c:if test="${e_list.valueListInfo.totalNumberOfEntries > 0}">
                            ...
                            <vlh:row bean="e">
                                ...
                                <td width="500px" class="pd3 r vhl_tr<%= (currentRowIdx % 2) %>" valign="top">
                                  ...
                                  if (null != en)
                                  {
                                      for (String key : en.getPropertyKeys())
                                      {
                                    	  ...
                                    	  String vShort = StringUtils.getShortStr(v, 55);
                                          %>
                                ...
                                <td class="pd3 vhl_tr<%= (currentRowIdx % 2) %>" >
                                    <c:forEach items="${e.relations}" var="r">
                                  ...
                                  <br/>
                                      ...
                                      <%
                                      Relation r = (Relation) pageContext.getAttribute("r");
                                      %>
                                      id : <%= r.getUuid() %>
                                      <%
                                      for (String key : r.getPropertyKeys())
                                      {
                                          String v = r.getProperty(key);
                                          String vShort = StringUtils.getShortStr(v, 55);
                                          %>
                                          <br/><%= key %> : <span title="<%= v %>"><%= vShort %></span>
                                          <%
