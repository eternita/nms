 ...
 * It has {@link LocaleConverter} and {@link org.neuro4j.apache.commons.beanutils.Converter} implementations,
...
public abstract class BaseLocaleConverter implements LocaleConverter {
    ...
    private Logger log = Logger.getLogger(BaseLocaleConverter.class.getName());
    ...
    public Object convert(Class type, Object value, String pattern) {
        if (value == null) {
            if (useDefault) {
                ...
                log.finest("Null value specified for conversion, returing null");
                return null;
            }
        }
