...
import org.neuro4j.apache.commons.beanutils.Converter;
    ...
    protected Object handleError(Class type, Object value, Throwable cause) {
        ...
        if (cause instanceof ConversionException) {
            cex = (ConversionException)cause;
            	...
            	log().log(Level.WARNING,"    Re-throwing ConversionException: " + cex.getMessage());
            ...
            cex = new ConversionException(msg, cause);
                ...
                log().log(Level.WARNING, "    Throwing ConversionException: " + msg);
