...
public class StringLocaleConverter extends BaseLocaleConverter {
    ...
    private Logger log = Logger.getLogger(StringLocaleConverter.class.getName());     //msz fix
     ...
     *
     * @exception org.neuro4j.apache.commons.beanutils.ConversionException if conversion
    ...
    private DecimalFormat getDecimalFormat(Locale locale, String pattern) {
        ...
        if (pattern != null) {
            ...
            log.finest("No pattern provided, using default.");
        }
